...
websocket.onmessage = function(e){
    ...
    list_messages.insertAdjacentHTML("afterbegin", `<p>${data.created}: ${JSON.parse(data.message)["message"]}</p>`)    
}
...
form.addEventListener("submit", (e) => {
    ...
    body.append("created_by", document.querySelector(".user_connected").value)
